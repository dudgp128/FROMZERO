...
CREATE TABLE `offline_order` (
  ...
  KEY `offline_order_ibfk_2` (`offlineproduct_name`),
...
INSERT INTO `online_product` VALUES (1,'제로웨이스트 입문 키트\n','더피커',12000,'kit',NULL,1),(2,'스텐 고리집게(5p.)\n','더피커',4000,'living','집게',8),(3,'소창 2겹 행주 (손수건 대용)\n','더피커',4000,'bathroom','타월',1),(4,'비누 틴케이스\n','더피커',4500,'etc',NULL,4),(5,'유기농 메쉬 파우치(S)\n','더피커',3000,'living','주머니/가방',4),(6,'휴대용 소창와입스(4매입)\n','더피커',11000,'bathroom','타월',12),(7,'스텐 미니집게(10pcs.)\n','더피커',4000,'living','집게',9),(8,'유기농 메쉬 프로듀스백(S/M/L)\n','더피커',4000,'living','주머니/가방',10),(9,'광목 빨대 주머니\n','더피커',3000,'living','주머니/가방',5),(10,'신문지연필(5ea)\n','더피커',2000,'etc',NULL,2),(11,'[도서] 오늘을 조금 바꿉니다\n','더피커',13410,'living','책/노트',24),(12,'팔로산토 우드스틱\n','더피커',10000,'etc',NULL,6),(13,'[도서] 채식연습\n','더피커',15120,'living','책/노트',26),(14,'유기농면 프로듀스백(S/M/L)\n','더피커',4500,'living','주머니/가방',11),(15,'그랩 리페어 밀랍블록\n','더피커',1500,'kitchen','밀랍/시트',1),(16,'유기농 순면생리대 누르Nur.\n','더피커',6500,'etc',NULL,5),(17,'네츄럴 린넨 손수건\n','더피커',4000,'bathroom','타월',2),(18,'크라프트 무지 만년 위클리\n','더피커',2000,'living','책/노트',1),(19,'재생종이 볼펜\n','더피커',1500,'etc',NULL,1),(20,'소락 유기농 튤립백(도시락가방)\n','더피커',6000,'living','주머니/가방',15),(21,'[도서] 지구생활안내서 바질[BASIL]\n','더피커',13000,'living','책/노트',20),(22,'유기농 하프메쉬 에코백\n','더피커',12000,'living','주머니/가방',19),(23,'[도서] 그건 쓰레기가 아니라고요\n','더피커',14400,'living','책/노트',25),(24,'재활용 페트병 마켓백\n','더피커',13000,'living','주머니/가방',21),(25,'에코백\n','더피커',8000,'living','주머니/가방',17),(26,'A5 크라프트 무지노트\n','더피커',2000,'living','책/노트',2),(27,'대나무 연필깎이\n','더피커',2000,'etc',NULL,3),(28,'스테인리스 빨대(일자형)\n','더피커',3000,'living','빨대',6),(29,'프로듀스백 (M)\n','더피커',6000,'living','주머니/가방',16),(30,'재활용면 텀블러 가방\n','더피커',13000,'living','주머니/가방',22),(31,'[도서] 매거진쓸[SSSSL]\n','더피커',13000,'living','책/노트',23),(32,'유기농 스트링 에코백\n','더피커',10000,'living','주머니/가방',18),(33,'하누만 요가매트\n','더피커',149000,'etc',NULL,7),(34,'소창 프로듀스백(M)\n','더피커',5500,'living','주머니/가방',14),(35,'유기농 설거지 비누(100g/400g)\n','더피커',8000,'kitchen','설거지',7),(36,'유기농 재사용 커피필터\n','더피커',4000,'kitchen','밀랍/시트',2),(37,'SCHOTT 쇼트 유리빨대(단품/세트)\n','더피커',5000,'living','빨대',12),(38,'다회용 밀랍 주방랩(M/L)\n','더피커',4500,'kitchen','밀랍/시트',4),(39,'사이잘 빨대 세척솔\n','더피커',2000,'living','빨대',3),(40,'설거지용 팟 브러쉬\n','더피커',6000,'kitchen','설거지',5),(41,'소창 3겹 핸드타월\n','더피커',8000,'bathroom','타월',9),(42,'설거지용 롱핸들 브러쉬\n','더피커',6500,'kitchen','설거지',6),(43,'스테인리스 빨대(ㄱ자형)\n','더피커',3500,'living','빨대',7),(44,'천연 설거지 수세미 (S/L)\n','더피커',4000,'kitchen','설거지',3),(45,'다회용 밀랍 푸드백(S/L)\n','더피커',5000,'living','주머니/가방',13),(46,'생분해 천연 치실/리필\n','더피커',7000,'bathroom','샤워',6),(47,'친환경 대나무 칫솔\n','더피커',5500,'bathroom','샤워',5),(48,'유기농 햄프코튼 재사용 화장솜\n','더피커',12000,'bathroom','타월',13),(50,'스테인리스 혀클리너\n','더피커',7000,'bathroom','샤워',7),(51,'천연 목욕수세미(어린수세미)\n','더피커',4000,'bathroom','샤워',3),(52,'천연 비누주머니\n','더피커',5000,'bathroom','비누',4),(53,'유기농 온몸비누 제주\n','더피커',8000,'bathroom','비누',10),(54,'소창 2겹 세안수건\n','더피커',7000,'bathroom','타월',8),(55,'천연 수세미 목욕장갑\n','더피커',10000,'bathroom','샤워',11),(56,'플랑드비 올라이트 바디솝\n','더피커',17000,'bathroom','비누',14),(57,'재사용 화장지(10매입)\n','더피커',25000,'bathroom','샤워',15),(58,'제로웨이스트 구강위생 키트\n','더피커',22000,'kit',NULL,2),(59,'[예고은] 삼베수세미(3개입)\n','지구샵',8500,'kitchen','설거지',22),(60,'주방비누\n','지구샵',5200,'kitchen','설거지',16),(61,'[소렉스] 과일채소 세척솔\n','지구샵',6000,'kitchen','설거지',17),(62,'[예고은] 삼베행주\n','지구샵',7900,'bathroom','타월',32),(63,'[손끋비] 밀랍랩 비기너세트(3매입)\n','지구샵',10000,'kitchen','밀랍/시트',25),(64,'[소렉스] 보틀 세척솔\n','지구샵',10000,'kitchen','설거지',26),(65,'[소렉스] 구리수세미 3pcs\n','지구샵',10000,'kitchen','설거지',27),(66,'[손끋비] 밀랍랩(Large)\n','지구샵',7000,'kitchen','밀랍/시트',20),(67,'[예고은] 삼베찜시트\n','지구샵',6200,'kitchen','밀랍/시트',19),(68,'[소렉스] 팬용 세척솔\n','지구샵',7000,'kitchen','설거지',21),(69,'[손끋비] 밀랍랩(Small)\n','지구샵',5000,'kitchen','밀랍/시트',15),(70,'[손끋비] 밀랍랩 DIY세트(교육/체험용)\n','지구샵',9900,'kitchen','밀랍/시트',23),(71,'[레데커] 스크럽 세척솔\n','지구샵',6000,'kitchen','설거지',18),(72,'천연 물방울수세미\n','지구샵',3500,'kitchen','설거지',13),(73,'천연 통수세미\n','지구샵',3500,'kitchen','설거지',14),(74,'천연물방울수세미(3개입)\n','지구샵',9900,'kitchen','설거지',24),(75,'고체치약\n','지구샵',5900,'bathroom','샤워',31),(76,'대나무칫솔(성인/어린이용)\n','지구샵',3500,'bathroom','샤워',29),(77,'[소락] 면화장솜 4pcs\n','지구샵',10000,'bathroom','타월',33),(78,'[예고은] 삼베샤워타월\n','지구샵',11900,'bathroom','샤워',35),(79,'칫솔 파우치\n','지구샵',3500,'living','주머니/가방',38),(80,'[더비건글로우] 오리지널 샴푸바\n','지구샵',15000,'bathroom','비누',37),(81,'유기농 핸드타월 (3매)\n','지구샵',12000,'bathroom','타월',36),(82,'[솝퓨리]안티로쓰 샴푸바(탈모방지)\n','지구샵',18000,'bathroom','비누',40),(83,'[솝퓨리]네버드라이 페이셜바\n','지구샵',15000,'bathroom','비누',38),(84,'유기농 수건 (3매)\n','지구샵',19500,'bathroom','타월',42),(85,'[솝퓨리]리치리치 샴푸바(건성용)\n','지구샵',18000,'bathroom','비누',41),(86,'[솝퓨리]오오클렌징바(여성청결제)\n','지구샵',24000,'bathroom','비누',43),(87,'[솝퓨리]노세범 샴푸바(지성용)\n','지구샵',16000,'bathroom','비누',39),(88,'스테인레스 칫솔걸이\n','지구샵',4000,'bathroom','샤워',30),(89,'면비누망\n','지구샵',2500,'bathroom','비누',28),(90,'[소락] 유기농 면마스크\n','지구샵',6000,'etc',NULL,14),(91,'[소락] 휴대용 와입스(4매입)\n','지구샵',11000,'bathroom','타월',34),(92,'메쉬백\n','지구샵',8000,'living','주머니/가방',40),(93,'프로듀스백\n','지구샵',4000,'living','주머니/가방',39),(94,'[프리다]플로우 밀랍초\n','지구샵',10000,'etc',NULL,15),(95,'[프리다]생일초\n','지구샵',1000,'etc',NULL,11),(96,'[프리다]꽈배기 생일초\n','지구샵',1100,'etc',NULL,12),(97,'[프리다]노랑성냥\n','지구샵',4000,'etc',NULL,13),(98,'[루디아의베틀] 미니크로스백\n','지구샵',45600,'living','주머니/가방',44),(99,'[바잇미] 미니에코백\n','지구샵',8900,'living','주머니/가방',41),(100,'[프리다]담금초 세트\n','지구샵',52000,'kit',NULL,6),(101,'[프리다]흐르는 작은 초\n','지구샵',22000,'etc',NULL,17),(102,'[바잇미] 데일리 산책가방\n','지구샵',30900,'living','주머니/가방',42),(103,'[프리다]코르크 밀랍초\n','지구샵',20000,'etc',NULL,16),(104,'[루디아의베틀] 루디아백\n','지구샵',40000,'living','주머니/가방',43),(105,'[루디아의베틀] 코스타백\n','지구샵',74600,'living','주머니/가방',45),(106,'친환경 제로웨이스트 주방용 다용도 천연 수세미\n','제로웨이스트샵',800,'kitchen','설거지',8),(107,'친환경 제로웨이스트 내열 유리빨대 4종 세트\n','제로웨이스트샵',6600,'living','빨대',29),(108,'유리빨대 파우치 세트\n','제로웨이스트샵',9900,'living','주머니/가방',30),(109,'내열 유리빨대 스무디용 12mm\n','제로웨이스트샵',2000,'living','빨대',28),(110,'내열 유리빨대 일반용 8mm\n','제로웨이스트샵',1500,'living','빨대',27),(111,'친환경 제로웨이스트 미세모 대나무 칫솔\n','제로웨이스트샵',980,'bathroom','샤워',16),(112,'[E,art] 천연 루파 수세미 열매','지구살림e',3790,'kitchen','설거지',9),(113,'[e,art] 먼지없는 강화 소창 2겹 행주 (면100%)','지구살림e',2100,'bathroom','타월',20),(114,'[E,art] 프리미엄 강화 소창 와입스','지구살림e',1350,'bathroom','타월',18),(115,'[E,art] 친환경 스테인리스 빨대','지구살림e',500,'living','빨대',31),(116,'[e,art] 스텐 훅 집게','지구살림e',500,'living','집게',32),(117,'E,art 디쉬바 옐루칼립투스','지구살림e',5000,'kitchen','설거지',12),(118,'[E,art] 프리미엄 강화 소창 원단 2겹 3겹','지구살림e',2900,'living','타월',35),(119,'[E,art] 광목 주머니','지구살림e',1800,'living','주머니/가방',34),(120,'[E,art] 삼베 수세미','지구살림e',3790,'kitchen','설거지',10),(121,'E,art 친환경 대나무 빨대','지구살림e',1300,'living','빨대',33),(122,'[E,art] 천연 루파 텀블러 세척솔','지구살림e',4790,'kitchen','설거지',11),(123,'[E,art] 먼지없는 강화 소창 2겹 행주 5장 세트','지구살림e',12000,'kit',NULL,4),(124,'E,art 린넨 롱 앞치마','지구살림e',35800,'etc',NULL,10),(125,'E,art 골드 머그 1P','지구살림e',12500,'etc',NULL,8),(126,'E,art 포켓 장바구니','지구살림e',17800,'living','주머니/가방',37),(127,'제로웨이스트 네트백','지구살림e',4000,'living','주머니/가방',36),(128,'[E,art] 심플리 하프 에이프런 2종','지구살림e',18000,'etc',NULL,9),(129,'E,art 프리미엄 집들이 선물 세트','지구살림e',21300,'kit',NULL,5),(130,'과탄산소다 1kg 소창행주 정련 세제','지구살림e',3900,'bathroom','타월',21),(131,'밀랍초 비즈왁스 세트','지구살림e',11000,'kit',NULL,3),(132,'[E,art] 제로웨이스트 대나무 칫솔','지구살림e',1250,'bathroom','샤워',17),(133,'저자극 오이가지 바디 비누','지구살림e',6000,'bathroom','비누',24),(134,'[E,art] 프리미엄 소창 목욕수건','지구살림e',8300,'bathroom','타월',25),(135,'[E,art] 삼베 샤워타월','지구살림e',8300,'bathroom','샤워',26),(136,'규조토 비누 받침 심플 사각 트레이 1개','지구살림e',2000,'bathroom','비누',19),(137,'[e,art] 먼지없는 강화 소창 3겹 수건 (면100%)','지구살림e',5200,'bathroom','타월',23),(138,'저자극 바질 클렌징 비누','지구살림e',5000,'bathroom','비누',22),(139,'[e,art] 재사용 화장솜','지구살림e',8990,'bathroom','타월',27);
...
-- Dump completed on 2020-11-28 10:44:28
