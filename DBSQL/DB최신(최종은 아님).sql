...
INSERT INTO `bottle` VALUES ('khhong',3,2,2,0,1380);
...
CREATE TABLE `cart` (
  ...
  CONSTRAINT `cart_ibfk_1` FOREIGN KEY (`custid`) REFERENCES `customer` (`custid`) ON DELETE CASCADE,
  CONSTRAINT `cart_ibfk_2` FOREIGN KEY (`productid`) REFERENCES `online_product` (`productid`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `customer` VALUES ('5','7','8','9','4',NULL),('ã','s','ã','ã·ã','ã',NULL),('khhong','1111','홍기형','충남','02-920-7525',NULL),('test','0','조영혜','서울시 성북구 ','0100000000',NULL);
...
-- Dump completed on 2020-12-02  2:12:44
