	...
	<div class="inside">
		...
		<div class="info">
			<div class="intro">
				...
				<div class="total-price" style='font-size: 16px; padding: 10px; font-size:larger'>
				<p>누적 구매금액  : <%=all_price %>원</p>
				<p style= "font-size:smaller; color: green;"><strong>*누적 구매금액은 온라인 구매 상품에 대해서만 적용됩니다.</strong></p>
				</div>
			</div>
