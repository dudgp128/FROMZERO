...
<body style="overflow-x: hidden">
	...
	<div style="margin-left: 120px" class="div-shop-grid">
		<ul class="ul-shop-grid" style="margin-right: 0">
			<a href="living.jsp"><h2 style="margin-left: 0"
					class="big-category-text">LIVING ></h2></a>
			<%
					try {
				...
				%>
			<form style="margin-right: 0; width: 100%" method="post"
		...
		<ul class="ul-shop-grid" style="margin-right: 0">
			<a href="bathroom.jsp"><h2 style="margin-left: 0"
					class="big-category-text">BATHROOM ></h2></a>
			<%
					try {
					conn = DriverManager.getConnection(DBUrl, connectionProps);
		...
		<ul class="ul-shop-grid" style="margin-right: 0">
			<a href="kitchen.jsp"><h2 style="margin-left: 0"
					class="big-category-text">KITCHEN ></h2></a>
			<%
					try {
					conn = DriverManager.getConnection(DBUrl, connectionProps);
		...
		<ul class="ul-shop-grid" style="margin-right: 0">
			<a href="kit.jsp"><h2 style="margin-left: 0"
					class="big-category-text">KIT ></h2></a>
			<%
					try {
					conn = DriverManager.getConnection(DBUrl, connectionProps);
		...
		<ul class="ul-shop-grid" style="margin-right: 0">
			<a href="etc.jsp"><h2 style="margin-left: 0"
					class="big-category-text">ETC ></h2></a>
			<%
					try {
					conn = DriverManager.getConnection(DBUrl, connectionProps);
