...
<body style="overflow-x: hidden">
	...
	<div class="question_box" style="background-color: #FFFFFF">
		<table>
			<tr>
				<th style="border-bottom: 1px solid #444444;">주문상품</th>
				<th style="border-bottom: 1px solid #444444;">주문자 아이디</th>
				<th style="border-bottom: 1px solid #444444;">가격</th>
				<th style="border-bottom: 1px solid #444444;">개수</th>
				<th style="border-bottom: 1px solid #444444;">주문날짜</th>
			</tr>
			<%
			...
			try {
				...
				String sqlSt = "select offlineproduct_name, item.custid, offlineproduct_price,count,orderdate from offline_product,offline_order_items item,offline_order where offline_order.orderid=item.orderid and  offline_product.offlineproduct_id=item.productid and item.storeid="
				+ storeid;
