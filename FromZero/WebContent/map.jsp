...
<style>
    ...
    .desc .contact {font-size: 11px;color: #888;margin-top: -2px;}
...
<body style="overflow-x: hidden">
	...
	<script>
		...
		var marker = new kakao.maps.Marker({
		    map: map, 
		    position: new kakao.maps.LatLng(37.55373305663804, 126.91155422580078)	// 알맹상점
		});
		...
		var content = '<div class="wrap">' + 
		            ...
		            '                <div><a href="introduce.jsp" target="_blank" class="link">홈페이지</a></div>' + 
		            '            </div>' + 
		            '        </div>' + 
		            '    </div>' +    
		            '</div>';
