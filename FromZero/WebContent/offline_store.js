function Store1(){
	...
	document.getElementById("name_td").innerHTML="알맹상점";
...
function Store2(){
	...
	document.getElementById("name_td").innerHTML="지구샵";
...
function Store3(){
	...
	document.getElementById("name_td").innerHTML="더피커";
...
function Store6(){
	document.getElementById("img_td").src="images/offline_store-2.jpg";
	document.getElementById("name_td").innerHTML="디어얼스";
